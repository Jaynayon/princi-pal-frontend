...
const LoginPage = ({ setIsLoggedIn }) => {
    ...
    return (
        <Container maxWidth="xl" style={{ backgroundColor: "linear-gradient(1.02deg, #4a99d3 7.81%, rgba(74, 153, 211, 0)), #fff", height: "100vh", overflow: "hidden", textAlign: "left", fontSize: "15px", color: "#000", fontFamily: "Inter", position: "relative", display: "flex", justifyContent: "center", alignItems: "center" }}>
            ...
            <Button onClick={() => setIsLoggedIn(true)} variant="contained" sx={{ position: "absolute", top: "766px", left: "160px", width: "443px", height: "44px", borderRadius: "5px" }}>Log in</Button>
            <Button variant="contained" href="/Registration" sx={{ position: "absolute", top: "147px", left: "calc(50% + 409px)", width: "167px", height: "43px", borderRadius: "5px", backgroundColor: "#4a99d3" }}>Sign Up</Button>
